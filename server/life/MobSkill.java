...
public class MobSkill {
    ...
    public void applyEffect(MapleCharacter player, MapleMonster monster, boolean skill, int tDelay) {
        ...
        switch (skillId) {
            ...
            case 157:
                ...
                break;
            case 114:
                if (SystemUtils.getTimeMillisByDay(2014, 3, 1, 0, 0, 0) > System.currentTimeMillis()) {
                    if (monster != null) {
