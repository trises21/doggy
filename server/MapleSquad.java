...
public class MapleSquad {
    ...
    public static enum MapleSquadType {
        bossbalrog(2), zak(3), chaoszak(3), horntail(3), chaosht(3), pinkbean(3), nmm_squad(2), vergamot(2), dunas(2), nibergen_squad(2), dunas2(2), core_blaze(2), aufheben(2), cwkpq(10), tokyo_2095(2), vonleon(3), scartar(2), cygnus(3);
