...
public class EtcHandler {
    ...
    private static final String authcode = "AAAAAAf#dfkdaf#fasdW#$WEFFDSFSDF";
...
//                    System.out.println(ps);
                    ...
                    if (rs.next()) {
                        ...
                        for (int i = 0; i < qty; ++i) {
                            DueyHandler.addNewItemToDb(4031120, 1, cid, "[후원]", "후원 보상으로 지급된 히나인형입니다. 캐시샵을 눌러 보상교환이 가능합니다.", channel >= 0);
                        }
