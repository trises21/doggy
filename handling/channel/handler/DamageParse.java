...
//            elementalMaxDamagePerMonster += (elementalMaxDamagePerMonster * player.getDamageIncrease(monster.getObjectId()) / 100.0);
    ...
    public static final AttackInfo parseAttack(final LittleEndianAccessor lea, final MapleCharacter chr, RecvPacketOpcode recv) {
        ...
        // ranged     1C 00 00 01 9D BA 3E 00 00 B7 07 02 28 A2 18 01 01 00 00 00 41 90 03 4D FF 4F 03 31 FF
        // energy orb 1C 00 00 [11] [EA 23 4E 00] [00] [D1] [08] [05] [76 83 F0 10] [00 00] [00 00] [00] [22 A1 07 00] [06 0C 06 01 E8 FD 7F 01 E9 FD 7E 01 8C] 03 CA D5 00 00 79 FE 6F 01 79 FE 53 01

        // rapid      1C 00 02 [01] [8C AA 4F 00] [00] 00 00 00 00 DC 09 05 AF 55 3C 11 0B 00 00 00 3D 71 00 D7 00 34 00 BB 00

        // close      1B 00 02 11 F1 03 00 00 00 6F 09 05 0F D0 A7 13 
...
//                }
        ...
        for (AttackPair oned : attack.allDamage) {
            if ((attack.skill != 3211003 && attack.skill != 4111004 && attack.skill != 4221001) || attack.display == 58) {
