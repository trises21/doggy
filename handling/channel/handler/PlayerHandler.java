...
//        }
    ...
    public static final void rangedAttack(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        ...
        if (!AOE && chr.getBuffedValue(MapleBuffStat.SOULARROW) == null) {
...
//            }
            slea.skip(1);
            final boolean wheel = slea.readByte() > 0 && !GameConstants.isEventMap(chr.getMapId()) && chr.haveItem(5510000, 1, false, true) && chr.getMapId() / 1000000 != 925;
