...
//            updatePokemonCaught(con);
        ...
        System.out.println("[VaconMaple] Done loading Rankings in " + ((System.currentTimeMillis() - startTime) / 1000) + " seconds :::"); //keep
    }
    ...
    private static void updateRanking() throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (name.equals("브로리") || name.equals("포로리") || name.equals("고로리") || name.equals("아기부노조타") || name.equals("릿카") || name.equals("로리로리")) {
                    continue;
                }
