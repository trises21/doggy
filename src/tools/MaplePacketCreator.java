...
public class MaplePacketCreator {
    ...
    public static final byte[] getServerIP(int port, int clientId, String IP) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();

        mplew.writeOpcode(SendPacketOpcode.SERVER_IP.getValue());
        mplew.writeShort(0);
        mplew.write(GameConstants.getServerIp(IP));
    ...
    public static final byte[] getChannelChange(int port, String IP) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
...
//        }
        ...
        if (SystemUtils.getTimeMillisByDay(2013, 9, 18, 0, 0, 0) < System.currentTimeMillis() && System.currentTimeMillis() < SystemUtils.getTimeMillisByDay(2013, 9, 21, 0, 0, 0)) {
            mplew.writeShort(1);
